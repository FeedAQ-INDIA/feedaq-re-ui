...
import {CheckLine, Map, MessageCircle, Phone} from "lucide-react";
            ...
            <div className="px-2 md:px-6  my-3 mt-5 ">
                ...
                <div className="mb-6 flex gap-2 flex-col">
                    ...
                    <div className="flex-wrap flex items-center gap-2 my-2">
                        <Link className=" "
                              href={`https://wa.me/${listing?.pgContact}?text=Hey ! I want detail regarding ${listing.pgName} - ${listing.title} !  Listing Id - ${listing.id}`}
                              target="_blank">
                ...
                <div className="grid grid-cols-1 lg:grid-cols-4 gap-4 my-4">
                    <div className=" lg:col-span-3">
                        ...
                        <div className="my-6">
                            <h2 className="font-bold text-xl  tracking-wide">Room Detail</h2>
                                    ...
                                    {listing.pgroomdetail.map((room, idx) => (
                                        <div key={room.id} className="p-2 border rounded-md bg-gray-50 space-y-1">
                                            ...
                                            <div className="flex flex-wrap gap-2 text-xs">
                                                ...
                                                <Badge variant="outline"
                                                       className={`rounded-sm ${room.isAirConditioned ? 'bg-blue-500' : 'bg-gray-500'} text-white`}>
